    ...
    <div className="relative z-10 flex min-h-dvh flex-col items-center justify-center p-4">
      <div className="w-full max-w-[440px]">
        <div className="mb-8 flex flex-col items-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-stitch-fg">POS Premium</h2>
          <p className="mt-2 text-stitch-fg-muted">Manage your business from anywhere</p>
        </div>

        <div className="auth-glass auth-glow rounded-2xl p-8 shadow-2xl">
          <div className="mb-6">
            <h1 className="mb-1 text-2xl font-bold text-stitch-fg">Welcome back</h1>
            <p className="text-sm text-stitch-fg-muted">Please enter your details to sign in.</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="ml-1 flex items-center justify-between">
                <label className="text-sm font-medium text-stitch-fg-secondary">Password</label>
                <Link
            ...
            <div className="flex items-center space-x-2 px-1">
              ...
              />
              <label htmlFor="remember" className="text-sm text-stitch-fg-muted">
                Keep me logged in
              </label>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#211115] px-2 text-stitch-fg-muted">Quick access</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              type="button"
              className="flex items-center justify-center gap-2 rounded-lg border border-stitch-primary/20 py-2.5 text-sm font-medium text-stitch-fg-secondary transition hover:bg-stitch-primary/5"
              disabled
        ...
        <p className="mt-8 text-center text-stitch-fg-muted">
      ...
      <div className="pointer-events-none fixed bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-6 text-[10px] font-medium uppercase tracking-widest text-stitch-fg-muted opacity-50">
